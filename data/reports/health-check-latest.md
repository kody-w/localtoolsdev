...
_Generated: 2026-06-26T08:56:49.680Z_

- **Total**: 606
- **Pass**: 511 (84.3%)
- **Fail**: 95
- **Avg load time**: 2993ms
...
| [`apps/games/wowmon-card-game-design-demo-improved.html`](https://kody-w.github.io/localFirstTools/apps/games/wowmon-card-game-design-demo-improved.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`http_404` apps/games/assets/textures/apex/wall_hex.png |
...
| [`v86-master/examples/serial.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/serial.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`console.error` Loading the image ../images/buildroot-bzimage68.bin failed (status %d) 404 |
...
| App | ms |
|---|---|
| `greenhouse-storm.html` | 12069 |
| `exhibitions/the-arcade/racing.html` | 12069 |
| `exhibitions/ai-research/pipboy-interface.html` | 12061 |
| `exhibitions/visual-arts/nexus.html` | 12036 |
| `v86-master/examples/async_load.html` | 12033 |
| `exhibitions/ai-research/nexus.html` | 12032 |
| `apps/quantum-worlds/cellular-multiverse.html` | 12030 |
| `exhibitions/visual-arts/pipboy-interface.html` | 12030 |
| `exhibitions/simulation-lab/nano-banana-chat-app.html` | 12029 |
| `exhibitions/ai-research/complete-implementation.html` | 12029 |
