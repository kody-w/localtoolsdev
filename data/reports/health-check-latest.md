...
_Generated: 2026-05-22T08:55:51.863Z_

- **Total**: 606
- **Pass**: 513 (84.7%)
- **Fail**: 93
- **Avg load time**: 2968ms

## Failing apps

| App | Errors |
|---|---|
| [`empty-cinema.html`](https://kody-w.github.io/localFirstTools/empty-cinema.html) | `console.error` THREE.WebGLProgram: Shader Error 0 - VALIDATE_STATUS false
...
| [`exhibitions/simulation-lab/quantum-garden.html`](https://kody-w.github.io/localFirstTools/exhibitions/simulation-lab/quantum-garden.html) | `pageerror` plant.color.getHex is not a function
QuantumGarden.broadcastPlant (http://localh |
...
| [`exhibitions/ai-research/wristAI.html`](https://kody-w.github.io/localFirstTools/exhibitions/ai-research/wristAI.html) | `console.error` Failed to load resource: the server responded with a status of 403 () |
...
| [`v86-master/examples/alpine.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/alpine.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`console.error` Loading the image ../images/alpine-fs.json failed (status %d) 404 |
...
| [`v86-master/examples/lua.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/lua.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`console.error` Loading the image ../images/buildroot-bzimage68.bin failed (status %d) 404 |
...
| [`v86-master/examples/broadcast-network.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/broadcast-network.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`console.error` Loading the image ../images/buildroot-bzimage68.bin failed (status %d) 404 |
...
| [`exhibitions/ai-research/vibe-terminal.html`](https://kody-w.github.io/localFirstTools/exhibitions/ai-research/vibe-terminal.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`http_404` apps/development/data/config/utility_apps_config.json |
...
| [`exhibitions/the-arcade/ancient-ruins-dying-star.html`](https://kody-w.github.io/localFirstTools/exhibitions/the-arcade/ancient-ruins-dying-star.html) | `pageerror` Unexpected strict mode reserved word |
...
| [`exhibitions/the-arcade/impossible-architecture-museum.html`](https://kody-w.github.io/localFirstTools/exhibitions/the-arcade/impossible-architecture-museum.html) | `console.error` Failed to load save data: TypeError: Cannot read properties of undefined (readin |
...
| [`apps/uncategorized/invisible-strings.html`](https://kody-w.github.io/localFirstTools/apps/uncategorized/invisible-strings.html) | `pageerror` Cannot access 'forceFields' before initialization |
...
| [`apps/creative/morning-dew-canvas.html`](https://kody-w.github.io/localFirstTools/apps/creative/morning-dew-canvas.html) | `pageerror` Cannot access 'timeOfDay' before initialization |
| [`apps/uncategorized/neon-archaeology.html`](https://kody-w.github.io/localFirstTools/apps/uncategorized/neon-archaeology.html) | `pageerror` Cannot access 'signs' before initialization |
| [`apps/uncategorized/patina-forge.html`](https://kody-w.github.io/localFirstTools/apps/uncategorized/patina-forge.html) | `pageerror` Cannot access 'cracks' before initialization |
| [`apps/uncategorized/phosphorescent-revealer.html`](https://kody-w.github.io/localFirstTools/apps/uncategorized/phosphorescent-revealer.html) | `pageerror` Cannot access 'messages' before initialization |
...
| [`exhibitions/visual-arts/nexus.html`](https://kody-w.github.io/localFirstTools/exhibitions/visual-arts/nexus.html) | `console.error` Failed to acquire camera feed: NotFoundError: Requested device not found<br>`load_timeout` 12000ms |
| [`exhibitions/visual-arts/pipboy-interface.html`](https://kody-w.github.io/localFirstTools/exhibitions/visual-arts/pipboy-interface.html) | `console.error` Failed to acquire camera feed: NotFoundError: Requested device not found<br>`load_timeout` 12000ms |
| [`v86-master/examples/tcp_terminal.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/tcp_terminal.html) | `http_404` v86-master/images/buildroot-bzimage68.bin<br>`console.error` Failed to load resource: the server responded with a status of 404 (File not fou |
...
| App | ms |
|---|---|
| `exhibitions/simulation-lab/nano-banana-chat-app.html` | 12074 |
| `exhibitions/the-arcade/racing.html` | 12043 |
| `exhibitions/visual-arts/nexus.html` | 12037 |
| `exhibitions/visual-arts/pipboy-interface.html` | 12034 |
| `exhibitions/ai-research/pipboy-interface.html` | 12033 |
| `v86-master/examples/async_load.html` | 12030 |
| `exhibitions/ai-research/complete-implementation.html` | 12030 |
| `exhibitions/ai-research/nexus.html` | 12029 |
| `lenia-eden.html` | 12024 |
| `exhibitions/productivity-suite/exquisite-corpse-reactor.html` | 11276 |
