...
_Generated: 2026-05-15T08:46:05.541Z_

- **Total**: 606
- **Pass**: 511 (84.3%)
- **Fail**: 95
- **Avg load time**: 2978ms
...
| [`apps/uncategorized/vibe_gallery.html`](https://kody-w.github.io/localFirstTools/apps/uncategorized/vibe_gallery.html) | `http_404` apps/uncategorized/screenshots/universal-data-transformer%202.png<br>`console.error` Failed to load resource: the server responded with a status of 404 (File not fou |
...
| [`v86-master/examples/worker.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/worker.html) | `pageerror` NetworkError: Failed to execute 'importScripts' on 'WorkerGlobalScope': The scri<br>`http_404` v86-master/build/libv86.js |
...
| App | ms |
|---|---|
| `greenhouse-storm.html` | 12035 |
| `exhibitions/ai-research/complete-implementation.html` | 12034 |
| `exhibitions/simulation-lab/nano-banana-chat-app.html` | 12033 |
| `apps/quantum-worlds/cellular-multiverse.html` | 12033 |
| `exhibitions/visual-arts/pipboy-interface.html` | 12033 |
| `v86-master/examples/async_load.html` | 12032 |
| `exhibitions/ai-research/pipboy-interface.html` | 12032 |
| `exhibitions/the-arcade/racing.html` | 12032 |
| `exhibitions/visual-arts/nexus.html` | 12032 |
| `exhibitions/ai-research/nexus.html` | 12030 |
