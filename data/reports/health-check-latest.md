...
_Generated: 2026-08-04T08:26:00.936Z_

- **Total**: 606
- **Pass**: 512 (84.5%)
- **Fail**: 94
- **Avg load time**: 3120ms
...
| [`v86-master/examples/two_instances.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/two_instances.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`console.error` Loading the image ../images/linux4.iso failed (status %d) 404 |
...
| [`apps/games/wowmon-card-game-design-demo-improved.html`](https://kody-w.github.io/localFirstTools/apps/games/wowmon-card-game-design-demo-improved.html) | `http_404` apps/games/assets/textures/apex/holo_atlas.png<br>`console.error` Failed to load resource: the server responded with a status of 404 (File not fou |
...
| App | ms |
|---|---|
| `exhibitions/productivity-suite/acoustic-room-scanner.html` | 13294 |
| `exhibitions/productivity-suite/digital-twin-home.html` | 13190 |
| `museum-after-hours.html` | 12488 |
| `exhibitions/the-arcade/racing.html` | 12106 |
| `exhibitions/visual-arts/pipboy-interface.html` | 12080 |
| `apps/quantum-worlds/cellular-multiverse.html` | 12064 |
| `exhibitions/simulation-lab/nano-banana-chat-app.html` | 12050 |
| `v86-master/examples/async_load.html` | 12044 |
| `exhibitions/ai-research/complete-implementation.html` | 12044 |
