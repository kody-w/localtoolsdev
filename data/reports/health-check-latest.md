...
_Generated: 2026-09-10T10:21:10.755Z_
...
| [`v2/apps/creative_tools/windows95-emulator.html`](https://kody-w.github.io/localFirstTools/v2/apps/creative_tools/windows95-emulator.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`http_404` v2/apps/creative_tools/.ai/windows95-agent-state.json |

## 10 slowest loads

| App | ms |
|---|---|
| `observatory-3am.html` | 12581 |
| `exhibitions/productivity-suite/acoustic-room-scanner.html` | 12113 |
| `exhibitions/visual-arts/pipboy-interface.html` | 12085 |
| `exhibitions/the-arcade/racing.html` | 12080 |
| `exhibitions/ai-research/pipboy-interface.html` | 12077 |
| `exhibitions/visual-arts/nexus.html` | 12070 |
| `exhibitions/productivity-suite/exquisite-corpse-reactor.html` | 12062 |
| `exhibitions/simulation-lab/nano-banana-chat-app.html` | 12060 |
